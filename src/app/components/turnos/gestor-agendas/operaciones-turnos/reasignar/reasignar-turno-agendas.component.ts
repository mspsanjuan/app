...
export class ReasignarTurnoAgendasComponent implements OnInit {
    ...
    hayTurnosDisponibles(agenda: any) {
        const profesionalOrigen = this.agendaAReasignar.profesionales.length > 0 ? this.agendaAReasignar.profesionales[0].id : null;
        const profesionalDestino = agenda.profesionales.length > 0 ? agenda.profesionales[0]._id : null;
